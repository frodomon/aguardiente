<?php //Template Name: Empresas Page
...
<body id="empresa">
  <header>
	...
	<section id="comunicacion-empresas" class="group">
		...
		<div class="white-square group">
			...
			<div class="w40">
				<img class="img-killa-quotes" style="height:70px; margin-bottom: 10px;" src="<?php print IMAGES.'/Killary-logo.png'; ?>" alt="Killary" />
				<img class="img-killa-quotes" style="height:30px; margin-bottom: 10px;" src="<?php print IMAGES.'/Killary-quote.png'; ?>" alt="Killary q" />
				<a href="https://www.killaryperu.com" target="_blank">
					<img class="img-killa-quotes" style="height:100px;" src="<?php print IMAGES.'/killary-link-page.png'; ?>" alt="Killary" />
				</a>
			</div>		
		</div>
	</section>
